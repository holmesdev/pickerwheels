...
const config = {
  ...
  // cacheDirectory: "/private/var/folders/vs/0x7x21ns1pq0nn8fg33r09700000gn/T/jest_dx",
  ...
  reporters: process.env.CI ? ['default', ['jest-junit', { outputDirectory: 'reports', outputName: 'jest.xml' }]] : ['default'],
  ...
  setupFiles: ['jest-canvas-mock', './.jest/setupEnvVars.js'],

  // A list of paths to modules that run some code to configure or set up the testing framework before each test
  setupFilesAfterEnv: ['./.jest/textEncoderPolyfill.js'],
